        ...
        switch (file) {
            case 'bio':
                fileContent.innerHTML = `
                    ...
                    <p>In 2016, they moved to Colorado for its outdoor recreational activities. After building a PC in 2019, they became curious about the universe inside these machines. Recognizing that certain principles of cosmology also governed the technology within their computer's CPU, was an astonishing epiphany that helped Sam appreciate the unity of science principles across the spectrum.</p>
                ...
                case 'education':
                    fileContent.innerHTML = `
                        ...
                        <p>During my 16 weeks there, I learned more than I thought I was capable of learning. The program not only taught me the basics of learning languages and the mechanics that come with them, but it also gave me the confidence to take on software engineering roles across the industry.</p>
                    `;
                    break;
            ...
            case 'programming':
                fileContent.innerHTML = `
                    ...
                    <p>My favorite aspect of programming is that there's always a way. With an ordinary toolset, anyone can create anything they envision and solve any problem they set their mind to. As I keep learning more, I appreciate the freedom in creating programs without being constrained by the limitations of pre-existing applications. Most exciting to me is the perpetual nature of learning and understanding the communication between man and machine. There's always more to learn, something new to explore and push the boundries of.</p>
                `;
                break;
            // case 'photography':
