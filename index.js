        ...
        switch (file) {
            case 'bio':
                fileContent.innerHTML = `
                    ...
                    <p>As they got older, they knew they had to break out of their shell. After high school, they took road trips all around the Western United States to visit Yellowstone, Glacier, Olympic, Redwood, Yosemite, Zion, Canyonlands, Arches, and Rocky Mountain National Parks. They realized how much of a privilege it was to live in the United States, appreciating how extraordinary and diverse its ecosystems and people are. They quickly developed a passion for environmental advocacy.</p>
                ...
                case 'education':
                    fileContent.innerHTML = `
                        ...
                        <p>Nearing the halfway point in the cohort, I learned all about garbage collection, the JVM, and debugging. We moved on to Java Libraries, dates, times, enums, and lambdas. Using the knowledge I had cultivated so far, I was able to efficiently complete the next project, "BlackJack". Each suite was an enum. We practiced using inheritance to build classes with objects as attributes, organizing data using collections, and creating game logic with conditionals.</p>
                        ...
                        <p>We were introduced to Spring MVC and MySQL databases to call methods in a controller class. We incorporated TDD using JUnit and JPA in all of our projects moving forward. Using Hibernate, we managed the connection to MySQL while we used JPA to translate from SQL to Java and back. For my project, I used JPQL to deal with the entities and properties. We combined Java into HTML using JSP files. I created a program for fourteen thousand foot mountains in Colorado, where a user could search for and display attributes for specific mountains.</p>
                        <p>Then we dove deep into RESTful services and Spring Data JPA leveraging JPA repositories, service interfaces, implementation classes for logic, and controllers. From here on, we tested all of our endpoints using Postman. I created an event tracker project to keep track of my dog Milo's schedule. For the front-end, I wrote both a JavaScript and an Angular version.</p>
